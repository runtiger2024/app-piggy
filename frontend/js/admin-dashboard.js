// frontend/js/admin-dashboard.js (V2026.1.1 - 整合傢俱代採購統計)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const mapping = {
    ...
    // [新增] 點擊代採購卡片跳轉至待處理清單
    "card-furniture-pending": "admin-furniture.html?status=PENDING",
  };
  ...
  async function loadDashboardStats() {
    try {
      ...
      // [新增] 顯示待處理傢俱訂單數 (需後端 reportController 同步回傳 furnitureStats)
      setText("stats-furniture-pending", stats.furnitureStats?.PENDING || 0);
